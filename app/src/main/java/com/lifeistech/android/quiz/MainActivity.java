...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeQuestions() {
        ...
        Question q5 = new Question(R.drawable.japan, "最南端の島がある都道府県は？", "東京", "埼玉", "鹿児島");
        Question q6 = new Question(R.drawable.fujisan, "この山の名前は？", "富士山","阿蘇山","高尾山");
        Question q7 = new Question(R.drawable.viola, "この楽器の名前は？", "ヴィオラ", "バイオリン", "チェロ" );
    ...
    private void nextQuestion() {
        ...
        // TODO [04] ここから
        status.setText(String.valueOf(current)+ "問中" + String.valueOf(correct_num) + "問正解"
                        +"残り"+ String.valueOf(correct_num - current) + "問");
